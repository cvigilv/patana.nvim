...
local hlgroups = {
	...
	MiniPickIconDirectory = { link = "Special" },
	MiniPickIconFile = { link = "Statement" },
	MiniPickHeader = { link = "Normal" },
	MiniPickMatchCurrent = { link = "Function" },
	MiniPickMatchMarked = { link = "Search" },
	MiniPickMatchRanges = { link = "MiniPickMatchCurrent" },
	MiniPickNormal = { link = "NormalFloat" },
	MiniPickPreviewLine = { link = "Normal" },
